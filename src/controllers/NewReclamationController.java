...
Integer b ,c;
    ...
    @FXML
    private TableColumn<Reclamation, ?> titre;
    @FXML
    private TableColumn<Reclamation, ?> text;
    @FXML
    ...
    public void affichetableview(){
        ...
        consulter.setCellFactory(
            ...
            public TableCell<Disposer.Record, Boolean> call(TableColumn<Disposer.Record, Boolean> p) {
             ...
             List<Reclamation> list = sReclamation.getbynew();
    ...
    private void modifier(ActionEvent event) {
       ...
       int        d=sReclamation.selectidSer(serv.getValue()).getId();
         ...
         Alert alert = new Alert(Alert.AlertType.ERROR);
                ...
                alert.setContentText("veriffiez les champs");
                alert.showAndWait();
           }
